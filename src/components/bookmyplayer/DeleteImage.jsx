...
const DeleteImage = ({ onClose, onDelete }) => {
  return (
    <div className="recycle-popup-wrapper">
      <div className="recycle-popup-container">
        <div className="recycle-popup-box">
          <p className="common-fonts restore-records">Delete</p>
          <p className="common-fonts selected-records-note">The selected image will get permanently deleted.</p>
