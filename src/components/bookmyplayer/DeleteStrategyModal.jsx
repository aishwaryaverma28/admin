...
const DeleteStrategyModal = ({ onClose }) => {
  return (
    <div className="recycle-popup-wrapper">
        
    <div className="recycle-popup-container">
        <div className="recycle-popup-box">
            <p className="common-fonts restore-records">Delete Strategy</p>
      <p className="common-fonts selected-records-note">The selected strategy will get permanently deleted.</p>
