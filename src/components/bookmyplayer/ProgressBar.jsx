            ...
            <div className="bmp-top-right">
                <div className="status-of-profile">
                    ...
                    <div className="progress-bar">
                        <div className={`bmp-small-circle ${array.includes("1") ? "bmp-completed-stage" : ""}`}>1</div>
                        <div className="bmp-line"></div>
                        <div className={`bmp-small-circle ${array.includes("2") ? "bmp-completed-stage" : ""}`}>2</div>
                        <div className="bmp-line"></div>
                        <div className={`bmp-small-circle ${array.includes("3") ? "bmp-completed-stage" : ""}`}>3</div>
                        <div className="bmp-line"></div>
                        <div className={`bmp-small-circle ${array.includes("4") ? "bmp-completed-stage" : ""}`}>4</div>
                    </div>
                </div>
