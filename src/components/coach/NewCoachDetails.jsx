...
const NewCoachDetails = React.forwardRef(({ user_id, id, updateCheckState }, ref) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        if (response?.data?.data[0]?.location) {
          const trainingLocationArray = response?.data?.data[0]?.location?.split('||');
          const trainCheckBox = trainingLocationArray[0]?.split(",");
        ...
        <div className="leadDetailsLeft">
          ...
          <div className="detailsBox">
            ...
            <div className="detailsContent">
              ...
              <div className="detailsRightContainer">
                <CoachFaq isEditable={isEditable} isDisabled={isDisabled} user_id={user_id} />
              </div>
            </div>
          </div>
        </div>
...
export default NewCoachDetails