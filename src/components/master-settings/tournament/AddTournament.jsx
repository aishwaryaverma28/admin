            ...
            <div className="bmp-upload">
              ...
              {/* 
                            {!selectedFile && (
                                <div className="bmp-image-preview">
                                    <img
                                        src={`https://res.cloudinary.com/cloud2cdn/image/upload/bookmyplayer/league/${fileLogoName}`}
                                        alt="logo"
                                        className="bmp-preview-image"
                                    />
                                </div>
            ...
            <div className="bmp-upload">
              ...
              {/* 
                            {!selectedBannerFile && (
                                <div className="bmp-image-preview">
                                    <img
                                        src={`https://res.cloudinary.com/cloud2cdn/image/upload/bookmyplayer/league/${fileBannerName}`}
                                        alt="logo"
                                        className="bmp-preview-image"
                                    />
                                </div>
              ...
              <div className="bmp-img-top-icon">
                <div className="bmp-img-name">
                  <div className="bmp-video">
                    <img
                      src={`https://res.cloudinary.com/cloud2cdn/image/upload/bookmyplayer/league/${photo}`}
                      alt="Selected Preview"
                    />
                  </div>
