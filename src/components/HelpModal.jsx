...
const HelpModal = ({onClose}) => {
  ...
  return (
    ...
    <button  
    className={`common-fonts ${activeTab === "question" ? "cp-active" : ""
  }` }  onClick={() => handleTabChange('question')}
    ><img src={activeTab === "question" ? QuestionBlue :Question} alt="" /></button>


    <button className={`common-fonts ${activeTab === "headphone" ? "cp-active" : ""
  }` }  onClick={() => handleTabChange('headphone')}
    ><img src={activeTab === "headphone" ?  HeaphoneBlue  : Heaphone} alt="" /></button>

   
    <button className={`common-fonts ${activeTab === "time" ? "cp-active" : ""
  }` }  onClick={() => handleTabChange('time')}
    ><img src={activeTab === "time" ? TimeBlue :Time} alt="" /></button>
