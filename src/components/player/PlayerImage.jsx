                ...
                {!selectedFile && (
                    <div className="bmp-image-preview">
                        <a href={academyData?.logo === null
                            ...
                            : `https://bmpcdn.s3.ap-south-1.amazonaws.com/player/${academyData?.id}/${academyData?.logo}`}
                                ...
                                <input
                                    ...
                                    <div className="bmp-video">
                                        <a href={`https://bmpcdn.s3.ap-south-1.amazonaws.com/player/${academyData?.id}/${photo}`} target="_blank" rel="noopener noreferrer">
                                            <img
                                                src={`https://bmpcdn.s3.ap-south-1.amazonaws.com/player/${academyData?.id}/${photo}`}
                                                alt="Selected Preview"
                                            />
                                        </a>
                                    </div>
                    ...
                    {videoUrls?.map((video, index) => (
                        <div className="bmp-new-img">
                            ...
                            <div className="bmp-player-img">
                                <a href={`https://bmpcdn.s3.ap-south-1.amazonaws.com/player/${academyData?.id}/${video}`} target="_blank" rel="noopener noreferrer">
                                    <video width="270" height="140" controls>
                                        <source
                                            src={`https://bmpcdn.s3.ap-south-1.amazonaws.com/player/${academyData?.id}/${video}`}
                                            type="video/mp4"
                                        />
                                    </video>
                                </a>
