   ...
   const submitImage2 = (file) => {
        ...
        if (selectedImage) {
            ...
            const configsWithDirNames = [
                { ...config, dirName: "player_temp/" + (id?.id || "") },
                { ...config, bucketName: "destcdn90", dirName: "player_temp/" + (id?.id || "") }
            ];
                        ...
                        {videoUrls?.map((video, index) => (
                            <div className="bmp-new-img">
                                ...
                                <div className="bmp-player-img">
                                    <a href={`${cdnurl}player_temp/${academyData?.id}/${video}`} target="_blank" rel="noopener noreferrer">
                                        <video width="270" height="140" controls>
                                            <source
                                                src={`${cdnurl}player_temp/${academyData?.id}/${video}`}
                                                type="video/mp4"
                                            />
                                        </video>
                                    </a>
