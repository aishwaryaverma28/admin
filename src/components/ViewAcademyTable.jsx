...
const ViewAcademyTable = ({ onClose }) => {
  ...
  const getData = (startDate, endDate) => {
    axios
      ...
      .then((response) => {
        console.log(response?.data?.data?.AcademyUserStats?.reverse());
  ...
  return (
    ...
    <div className="performance_title2">
      ...
      <span>ACADEMY DATA</span>
      <span>Total Academy: {academyCount?.length}</span>
