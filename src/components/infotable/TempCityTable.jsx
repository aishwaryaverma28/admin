    ...
    const fetchData = (page, limit) => {
        axios
            .post(
                GET_ALL_CITY,
                {
                    page: page.toString(), limit: limit.toString(), tbl: "adm_location_master_temp",
                    sort: "id asc",
                },
                {
                    headers: {
        ...
        <>
            ...
            <div className="marketing-all-table otp_table">
                <table>
                    ...
                    <tbody>
                        {allData?.map((item) => (
                            <tr key={item.id} onClick={() => addUrlModalClick(item)}>
            ...
            {openUrlModal && <MarkCity onClose={addUrlModalClose} rowData={selectedRowData} />}
            {addCity && (
                <AddCity onClose={closeModal} />
            )
            }
        </>
    );
